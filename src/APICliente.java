...
public class APICliente {
    ...
    private static final String API_URL = "https://v6.exchangerate-api.com/v6/ed6e61ab43ad11aa7adb6f8e/latest/BRL";
    ...
    private Map<String, Double> extrairTaxasCambio(String jsonResposta) {
        ...
        // Entradas do objeto "conversion_rates" para obter as taxas de câmbio
